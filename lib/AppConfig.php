...
class AppConfig {
	...
	public function getnmcMarketingUrlPublic(): string {
		return $this->config->getAppValue(Application::APPNAME, self::PUBLIC_WOPI_URL, $this->getnmcMarketingUrlInternal());
	}

	public function getnmcMarketingUrlInternal(): string {
